    ...
    <div className="home">
      ...
      <div className="about-section">
        <div className="about-grid">
          <div className="about-content">
            ...
            <p>"Визы и Путешествия" — это не просто турагентство. Мы создаём впечатления, которые остаются с вами на всю жизнь. Каждое путешествие разрабатывается индивидуально, учитывая все ваши пожелания и предпочтения.</p>
            <div className="stats">
              <div className="stat">
      ...
      <div className="quote-section">
        <div className="quote-content">
          ...
          <p>Мир — это книга, и тот, кто не путешествует, <br />читает лишь одну страницу.</p>
          <span>- Святой Августин</span>
        </div>
      </div>
